...
torch_x86_arch_flag_for("${CMAKE_HIP_COMPILER}" _bundled_rocm_arch_flag)
set(_bundled_rocm_host_arch_flags "")
if(_bundled_rocm_arch_flag)
  set(_bundled_rocm_host_arch_flags
    "-Xarch_host ${_bundled_rocm_arch_flag}")
endif()
...
ExternalProject_Add(pytorch_bundled_hipblaslt
  ...
  CMAKE_ARGS
    ...
    "-DCMAKE_CXX_FLAGS:STRING=${_bundled_rocm_libstdcxx_compat_flags} ${_bundled_rocm_arch_flag} -ffunction-sections -fdata-sections"
