...
if(USE_CUDA)
  ...
  if(CAFFE2_USE_CUDA)
    ...
    if(CAFFE2_USE_CUSPARSELT)
      if(CUSPARSELT_VERSION VERSION_LESS 0.8.0)
        message(FATAL_ERROR "PyTorch needs cuSPARSELt-0.8.0 or above, but found ${CUSPARSELT_VERSION}. Builds are still possible with `USE_CUSPARSELT=0`")
      endif()
...
set_property(CACHE BLAS PROPERTY STRINGS "Generic;MKL;OpenBLAS;vecLib")
...
elseif(BLAS STREQUAL "MKL")
  ...
  if(MKL_FOUND)
    ...
    message(WARNING "MKL could not be found. Building without a CPU BLAS; "
                    "set BLAS=OpenBLAS or BLAS=Generic to use one.")
...
set(USE_BLAS 1)
if(NOT (GENERIC_BLAS_FOUND OR MKL_FOUND OR OpenBLAS_FOUND OR VECLIB_FOUND))
...
# ---[ cuDNN
if(USE_CUDNN)
  if(CUDNN_VERSION VERSION_LESS 9.25)
    message(FATAL_ERROR "PyTorch needs CuDNN-9.25 or above, but found ${CUDNN_VERSION}. Builds are still possible with `USE_CUDNN=0`")
  endif()
...
if(USE_ROCM)
  ...
  if(PYTORCH_FOUND_HIP)
    ...
    string(APPEND CMAKE_HIP_FLAGS " --offload-compress")
    ...
    set(Caffe2_PUBLIC_HIP_DEPENDENCY_LIBS
      hip::host libhipcxx::libhipcxx)
    list(APPEND Caffe2_HIP_DEPENDENCY_LIBS
      MIOpen roc::rocblas roc::hipblaslt)

    # Math libraries
    list(APPEND Caffe2_PUBLIC_HIP_DEPENDENCY_LIBS
      roc::hipblas hip::hipfft roc::hipsparse roc::hipsolver roc::rocsolver)
