...
if(CAFFE2_CMAKE_BUILDING_WITH_MAIN_REPO AND NOT INTERN_DISABLE_ONNX)
  ...
  if(NOT USE_SYSTEM_ONNX)
    ...
    if(NOT EXISTS "${ONNX_SOURCE_DIR}/CMakeLists.txt.tag")
      file(READ "${ONNX_SOURCE_DIR}/CMakeLists.txt" FILE_CONTENTS)
      string(REPLACE "https://github.com/abseil/abseil-cpp/archive/refs/tags/20230125.3.tar.gz" "https://github.com/abseil/abseil-cpp/releases/download/20240116.2/abseil-cpp-20240116.2.tar.gz" FILE_CONTENTS "${FILE_CONTENTS}")
      string(REPLACE "e21faa0de5afbbf8ee96398ef0ef812daf416ad8" "bb8a766f3aef8e294a864104b8ff3fc37b393210" FILE_CONTENTS "${FILE_CONTENTS}")
      string(REPLACE "https://github.com/protocolbuffers/protobuf/releases/download/v22.3/protobuf-22.3.tar.gz" "https://github.com/protocolbuffers/protobuf/releases/download/v27.1/protobuf-27.1.tar.gz" FILE_CONTENTS "${FILE_CONTENTS}")
      string(REPLACE "310938afea334b98d7cf915b099ec5de5ae3b5c5" "0f55f676d2a32f87cb0c0ce1c6cd28ba1efc383e" FILE_CONTENTS "${FILE_CONTENTS}")
      file(WRITE "${ONNX_SOURCE_DIR}/CMakeLists.txt" "${FILE_CONTENTS}")
      file(WRITE "${ONNX_SOURCE_DIR}/CMakeLists.txt.tag" "onnx")
    endif()
