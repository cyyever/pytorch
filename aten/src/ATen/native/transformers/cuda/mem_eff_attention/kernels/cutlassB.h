...
template <typename T> void dispatch_cutlassB_bf16_sm80(T cb, int cc) {
    ...
    if (cc == 89) cb(AttentionBackwardKernel<cutlass::arch::Sm80, cutlass::bfloat16_t, true, false, true, 128, 64, 96>(), fmha_cutlassB_bf16_aligned_128x64_k96_sm80);
...
template <typename T> void dispatch_cutlassB_f16_sm80(T cb, int cc) {
    ...
    if (cc == 89) cb(AttentionBackwardKernel<cutlass::arch::Sm80, cutlass::half_t, true, false, true, 128, 64, 96>(), fmha_cutlassB_f16_aligned_128x64_k96_sm80);
