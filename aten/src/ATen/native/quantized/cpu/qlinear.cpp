  ...
  if (!xnnp_linear_op ||
   ...
   auto output_min = kReluFused
    ...
    status = at::native::xnnp_utils::xnnp_create_fully_connected_nc(
        ...
        reinterpret_cast<int32_t*>(qbias.mutable_data_ptr<c10::qint32>()),
        output_zero_point,
        output_scale,
        output_min,
        output_max,
...
at::Tensor PackedLinearWeightsQnnp::apply_impl(
  ...
  if (!this->input_scale.has_value() ||
    ...
    int8_t* w_data = (int8_t*)weight_contig.mutable_data_ptr<c10::qint8>();
  ...
  const pytorch_qnnp_status runStatus = qnnpack::qnnpackLinear(
      ...
      output_min,
      output_max,
      (uint8_t*)input_contig.mutable_data_ptr<c10::quint8>(),
      cols_input /* input_stride */,
      packB->getPackedWeights(),
      (uint8_t*)output.mutable_data_ptr<c10::quint8>(),
      rows_w /* output_stride */,
