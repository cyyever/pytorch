...
class TestForeach(TestCase):
    ...
    def test_foreach_copy_mismatched_list_lengths(self, device):
        # The functional _foreach_copy bounds its loop by src and indexes self,
        # so a shorter self used to be read past its end -- a plain Python call
        # segfaulted. The in-place variant has always rejected the mismatch.
