...
class TestFlyDSLTemplate(TestCase):
    ...
    def test_scheduling_caches_device_arch(self):
        props = mock.Mock(gcnArchName="gfx1201:sramecc+:xnack-")
        with (
            mock.patch.dict(
                os.environ,
            ...
            self.assertEqual(FlyDSLScheduling._build_flydsl_gpu_arch(0), "gfx1201")
            self.assertEqual(FlyDSLScheduling._build_flydsl_gpu_arch(0), "gfx1201")
    ...
    @parametrize(
        ...
        (
            (
                {
                    "FLYDSL_GPU_ARCH": "gfx1201:sramecc+:xnack-",
            ...
            (
                {"FLYDSL_GPU_ARCH": "", "HSA_OVERRIDE_GFX_VERSION": "12.0.1"},
                False,
                None,
                "gfx1201",
            ),
