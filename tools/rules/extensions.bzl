...
def _pytorch_local_repos_impl(module_ctx):
    ...
    _new_local_repo(name = "fbgemm", path = "third_party/fbgemm", build_file = Label("@pytorch//third_party:fbgemm/BUILD.bazel"))
    ...
    _new_local_repo(name = "nlohmann", path = "third_party/nlohmann", build_file = Label("@pytorch//third_party:nlohmann.BUILD"))
