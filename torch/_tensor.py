...
class Tensor(torch._C.TensorBase):
    ...
    def __rsub__(self, other: "Tensor" | int | float | bool | complex) -> "Tensor":
        return _C._VariableFunctions.rsub(self, other)

    @_handle_torch_function_and_wrap_type_error_to_not_implemented
    def __rdiv__(self, other: "Tensor" | int | float | bool | complex) -> "Tensor":
    ...
    @_handle_torch_function_and_wrap_type_error_to_not_implemented
    def __rmod__(self, other: "Tensor" | int | float | bool | complex) -> "Tensor":
    ...
    @_handle_torch_function_and_wrap_type_error_to_not_implemented
    def __rpow__(self, other: "Tensor" | int | float | bool | complex) -> "Tensor":
        return torch.pow(other, self)

    @_handle_torch_function_and_wrap_type_error_to_not_implemented
    def __floordiv__(self, other: "Tensor" | int | float | bool) -> "Tensor":  # type: ignore[override]
        # TODO(rec): the superclass says it accepts complex here,
        # but torch.floor_divide says it doesn't.
        return torch.floor_divide(self, other)

    @_handle_torch_function_and_wrap_type_error_to_not_implemented
    def __rfloordiv__(self, other: "Tensor" | int | float | bool) -> "Tensor":  # type: ignore[override]
        return torch.floor_divide(other, self)

    @_handle_torch_function_and_wrap_type_error_to_not_implemented
    def __rlshift__(
        self, other: "Tensor" | int | float | bool | complex
    ) -> "Tensor":
