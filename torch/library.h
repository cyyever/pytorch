...
// Kept as no-ops so the registration macros in this tree, and out-of-tree code
// written against them, need not change. There is nothing left to select: the
// allowlist these consulted was driven by TORCH_OPERATOR_WHITELIST and friends,
// which nothing defines.
#define TORCH_SELECTIVE_CLASS(n) (n)
#define TORCH_SELECTIVE_NAME(n) (n)
#define TORCH_SELECTIVE_SCHEMA(n) (n)
