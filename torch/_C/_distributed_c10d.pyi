...
class Reducer:
    ...
    def _set_manual_finalization_required(self, required: bool) -> None: ...
    def _should_finalize_after_backward(self) -> bool: ...
    def _finalize_backward_manual(self) -> None: ...
...
class Backend:
    ...
    @property
    def _supports_time_estimate(self) -> bool: ...
    ...
    @property
    def supports_abort_hooks(self) -> bool: ...
...
def _dump_fr_trace(
    includeCollectives: bool | None = None,
    includeStackTraces: bool | None = None,
    onlyActive: bool | None = None,
    backend: str = "gloo",
) -> bytes: ...
def _dump_fr_trace_json(
    includeCollectives: bool | None = None,
    onlyActive: bool | None = None,
    backend: str = "gloo",
) -> bytes: ...
def _dump_fr_trace_file(
    rank: int,
    includeCollectives: bool | None = None,
    includeStackTraces: bool | None = None,
    onlyActive: bool | None = None,
...
def _reset_fr_trace(backend: str = "gloo") -> None: ...
