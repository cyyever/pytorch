...
-   Enables Tensor Parallelism in eager mode. Compared to legacy sharded-tensor approaches, DistributedTensor allows additional flexibility to mix sharding and replication.
