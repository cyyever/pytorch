...
auto handle_torch_function(
  ...
  py::object torch_api_function =
      PyObject_FastGetAttrString(torch_api, const_cast<char*>(func_name.c_str()));
...
auto handle_torch_function(
  ...
  py::object torch_api_function = PyObject_FastGetAttrString(
      torch_api,
      const_cast<char*>(func_name_override ? func_name_override
...
auto handle_torch_function_indexing(
  ...
  py::object func =
      PyObject_FastGetAttrString(THPVariableClass, const_cast<char*>(func_name));
...
static void append_overloaded_arg(
  ...
  PyObject* obj_type = obj_is_type ? obj : reinterpret_cast<PyObject*>(Py_TYPE(obj));
  for (auto& arg : *overloaded_args) {
