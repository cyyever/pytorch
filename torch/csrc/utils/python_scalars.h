  ...
  switch (scalarType) {
    ...
    case at::kHalf:
      *static_cast<at::Half*>(data) =
      ...
      break;
    case at::kFloat:
      *static_cast<float*>(data) = static_cast<float>(THPUtils_unpackDouble(obj));
      break;
    case at::kDouble:
      *static_cast<double*>(data) = THPUtils_unpackDouble(obj);
      break;
    case at::kComplexHalf:
      *static_cast<c10::complex<at::Half>*>(data) =
    ...
    case at::kComplexDouble:
      *static_cast<c10::complex<double>*>(data) = THPUtils_unpackComplexDouble(obj);
      break;
    case at::kBool:
