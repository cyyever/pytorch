...
struct ThreadLocalResults {
  ThreadLocalResults(
      ...
      : thread_state_{thread_state},
        ctx_{reinterpret_cast<TraceContext*>(TraceContextType.tp_alloc(&TraceContextType, 0))},
...
PythonTracer::PythonTracer(torch::profiler::impl::RecordQueue* queue)
  ...
  for (const auto thread_state : interpreterThreads()) {
    ...
    PyEval_SetProfile(PythonTracer::pyProfileFn, reinterpret_cast<PyObject*>(ctx));
  }
#if IS_PYTHON_3_12
