...
py::object dispatchDTensorOp(
  ...
  const bool participating =
      !checked_vectorcall(
           ...
           .is_none();
  const bool local_results_success =
      get_local_results(op, cached_sharding, participating, stack);
...
static PyObject* THPVariable_get_output_nr(
    THPVariable* self,
    void* /*unused*/) {
  HANDLE_TH_ERRORS
  if (check_has_torch_function((PyObject*)self)) {
...
static PyObject* THPVariable_is_sparse_csr(
    THPVariable* self,
    void* /*unused*/) {
  HANDLE_TH_ERRORS
  if (check_has_torch_function((PyObject*)self)) {
...
static PyObject* THPVariable_get_grad_dtype(
    THPVariable* self,
    void* /*unused*/) {
  HANDLE_TH_ERRORS
  if (check_has_torch_function((PyObject*)self)) {
...
static int THPVariable_set_real(
    PyObject* self,
    PyObject* real,
    void* /*unused*/) {
  HANDLE_TH_ERRORS
...
static int THPVariable_set_imag(
    PyObject* self,
    PyObject* imag,
    void* /*unused*/) {
  HANDLE_TH_ERRORS
