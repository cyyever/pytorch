...
static PyObject* copySlicesWrappedNode(PyObject* _self, void* _unused) {
  HANDLE_TH_ERRORS
  THPCppFunction* self = (THPCppFunction*)_self;
  auto* copy_slices = static_cast<CopySlices*>(self->cdata.get());
  return functionToPyObject(copy_slices->fn);
  END_HANDLE_TH_ERRORS
}

// NOLINTNEXTLINE(cppcoreguidelines-avoid-non-const-global-variables,cppcoreguidelines-avoid-c-arrays,modernize-avoid-c-arrays)
static struct PyGetSetDef copy_slices_properties[] = {
    THP_FUNCTION_DEFAULT_PROPERTIES,
    {(char*)"_wrapped_node", copySlicesWrappedNode, nullptr, nullptr, nullptr},
    {nullptr}};
...
void THPAutograd_initFunctions() {
  ...
  addClass<CopySlices, NoCtor>(
      module, CopySlicesClass, "CopySlices", copy_slices_properties);
