  ...
  py::class_<torch::autograd::InputMetadata>(m, "_InputMetadata")
      .def_property_readonly(
          ...
          [](const torch::autograd::InputMetadata& m) {
            PyObject* raw_obj =
                reinterpret_cast<PyObject*>(torch::getTHPDtype(m.dtype().toScalarType()));
      ...
      .def(
          ...
          [](const KinetoEvent& e) {
            return e.activityType() ==
                static_cast<uint8_t>(libkineto::ActivityType::USER_ANNOTATION) ||
                e.activityType() ==
                static_cast<uint8_t>(libkineto::ActivityType::GPU_USER_ANNOTATION);
          })
