...
struct ConcretePyInterpreterVTable final
  ...
  bool is_contiguous(const c10::TensorImpl* self, at::MemoryFormat /*memory_format*/)
      const override;
  c10::SymBool sym_is_contiguous(const c10::TensorImpl* self, at::MemoryFormat /*memory_format*/)
      const override;
  bool is_strides_like(const c10::TensorImpl* self, at::MemoryFormat /*memory_format*/)
      const override;
