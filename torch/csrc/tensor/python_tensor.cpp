...
static struct PyGetSetDef metaclass_properties[] = {
    {"dtype", reinterpret_cast<getter>(Tensor_dtype), nullptr, nullptr, nullptr},
    {"layout", reinterpret_cast<getter>(Tensor_layout), nullptr, nullptr, nullptr},
    {"is_cuda", reinterpret_cast<getter>(Tensor_is_cuda), nullptr, nullptr, nullptr},
    {"is_xpu", reinterpret_cast<getter>(Tensor_is_xpu), nullptr, nullptr, nullptr},
    {"is_sparse", reinterpret_cast<getter>(Tensor_is_sparse), nullptr, nullptr, nullptr},
    {"is_sparse_csr", reinterpret_cast<getter>(Tensor_is_sparse_csr), nullptr, nullptr, nullptr},
    {nullptr}};
...
static void set_type(
  ...
  type_obj.layout =
      reinterpret_cast<THPLayout*>(Py_NewRef(torch::getTHPLayout(layout_from_backend(backend))));
  type_obj.dtype = reinterpret_cast<THPDtype*>(Py_NewRef(torch::getTHPDtype(scalarType)));
  type_obj.is_cuda =
