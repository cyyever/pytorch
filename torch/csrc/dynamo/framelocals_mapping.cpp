...
FrameLocalsMapping::FrameLocalsMapping(FrameLocalsFrameType* frame)
    : _code_obj(py::cast<py::object>(reinterpret_cast<PyObject*>F_CODE(frame))) {
...
void FrameLocalsMapping::_realize_dict() {
  ...
  auto nlocalsplus = (reinterpret_cast<PyCodeObject*>(_code_obj.ptr()))->co_nlocalsplus;
...
py::tuple code_framelocals_names(py::handle code) {
  ...
  return py::cast<py::tuple>((reinterpret_cast<PyCodeObject*>(code.ptr()))->co_localsplusnames);
}
