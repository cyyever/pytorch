...
static PyObject* THPStorage_newSharedFilename(
    ...
    PyObject* args) {
  HANDLE_TH_ERRORS
  THPUtils_assert_ext(PyTuple_GET_SIZE(args) == 3, "tuple of 3 items expected");
...
static PyObject* THPStorage_newSharedFd(PyObject* _unused, PyObject* args) {
  HANDLE_TH_ERRORS
  THPUtils_assert_ext(PyTuple_GET_SIZE(args) == 2, "tuple of 2 items expected");
...
static PyObject* THPStorage_newSharedCuda(PyObject* _unused, PyObject* args) {
  HANDLE_TH_ERRORS
#ifdef USE_CUDA
  THPUtils_assert_ext(PyTuple_GET_SIZE(args) == 8, "tuple of 8 items expected");
...
PyObject* THPStorage_expired(PyObject* _unused, PyObject* arg) {
  HANDLE_TH_ERRORS
  THPUtils_assert_ext(THPUtils_checkLong(arg), "_expired(): arg must be an 'int'");
  c10::StorageImpl* weak_storage = (c10::StorageImpl*)PyLong_AsVoidPtr(arg);
...
PyObject* THPStorage_sharedFd(PyObject* self, PyObject* noargs) {
  ...
  THPUtils_assert_ext(ctx, "couldn't retrieve a shared file descriptor");
