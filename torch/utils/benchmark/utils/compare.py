...
class Table:
    ...
    def populate_rows_and_columns(self) -> tuple[tuple[_Row, ...], tuple[_Column, ...]]:
        ...
        for (num_threads, env, _), row in zip(self.row_keys, ordered_results, strict=False):
    ...
    def render(self) -> str:
        ...
        finalized_columns = ["  |  ".join(i.center(w) for i, w in zip(string_rows[0], col_widths, strict=False))]
